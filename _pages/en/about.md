...
# About Me
Qiao Yongchao is a PhD student in the School of Systems Science and Engineering, Sun Yat-sen University, class of 2026. My main research areas are **computer vision** and **multimodal learning**, covering cutting-edge topics such as semantic segmentation, pedestrian trajectory prediction, and embodied intelligent models. My PhD supervisor is Professor Li Xiong (https://ssse.sysu.edu.cn/teacher/667). I received my Master's degree from Minnan Normal University, where my Master's supervisor was Professor Yang Jingmin (https://cs.mnnu.edu.cn/info/1070/1234.htm). I have published numerous papers and my Google Scholar citations are continuously growing <a href='https://scholar.google.com/citations?user=68X3IpAAAAAJ' target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a>.
